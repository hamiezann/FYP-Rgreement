...
// describe("HouseRentalContract Accuracy Tests", function () {
...
//         const contract = await houseRentalContract.getContract(uniqueIdentifier, password);
//         expect(contract.landlord.name).to.equal("John Doe");
//         expect(contract.houseDetails.rent_address).to.equal("123 Main St");
//     });
// });
