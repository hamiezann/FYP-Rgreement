       ...
       <div className="form-container">
        ...
        <form onSubmit={handleSubmit}>
            <Form.Group className="mb-3" controlId="houseId">
                ...
                <Form.Control type="number" placeholder='Enter house Id' value={houseId} onChange={(e) => setHouseId(e.target.value)} required />
        ...
        <div className='house-detail'>
            {/* Pass submittedHouseId instead of houseId */}
            <DisplaySearchHouse houseId={submittedHouseId}/>
        </div>
       </div>
    );
}
